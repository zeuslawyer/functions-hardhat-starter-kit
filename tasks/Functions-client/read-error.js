task(
  ...
  "Reads the latest error returned to a FunctionsConsumer client contract"
)
  ...
  .setAction(async (taskArgs) => {
    ...
    console.log(
      `Reading error data from Functions client contract ${taskArgs.contract} on network ${network.name}`
    );
