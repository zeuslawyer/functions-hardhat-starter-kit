...
task(
  ...
  "Sets the DON public key in the Functions oracle contract"
).setAction(async () => {
  ...
  console.log(
    `Setting oracle OCR config for oracle ${
      networkConfig[network.name]["functionsOracle"]
    }`
  );
  ...
  console.log(
    `Waiting ${VERIFICATION_BLOCK_CONFIRMATIONS} blocks for transaction ${setTx.hash} to be confirmed...`
  );
